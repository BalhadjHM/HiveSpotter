...
<div class="w-1/5 p-4 hidden lg:flex flex-col justify-start items-center space-y-8 bg-dark text-primary">
    <ul class="w-full flex flex-col justify-center space-y-4">
        ...
        <li class="py-2 px-2 bg-secondary rounded-md text-center text-primary montserrat-semibold text-md duration-300 ease-out hover:text-primary hover:bg-accent"><a href="{{ route('dashboard.index', ['userId' => $userId]) }}">Show All Trackers</a></li>
