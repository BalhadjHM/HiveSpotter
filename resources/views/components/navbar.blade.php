<nav {{ $attributes->merge(['class' => 'bg-primary shadow']) }}>
    <div class="py-2 sm:py-3 px-6 lg:px-28 container mx-auto flex justify-between items-center">
        ...
        <ul class="hidden md:flex space-x-4 lg:space-x-8 montserrat-bold text-md">
            ...
            <li><a href="{{ route('user.signup') }}" class="py-2 px-8 bg-secondary text-dark rounded-full hover:bg-accent hover:text-primary duration-300 ease-in-out">Login</a></li>
        </ul>
