                ...
                <div id="tracker-card" class="w-full px-6 flex flex-col justify-center items-start bg-white border-slate-200 border p-4 rounded-lg shadow-md">
                        ...
                        <div id="drop-down" class="relative cursor-pointer">
                            ...
                            <div id="drop-menu" class="hidden absolute top-9 right-0">
                                <ul class="bg-white border border-slate-200 rounded-lg shadow-md overflow-hidden">
                                    <li class="w-44 py-3 px-4 flex items-center gap-2 text-dark text-sm text-left montserrat-medium hover:bg-slate-50  duration-300 ease-out">
                    ...
                    <div class="w-full flex flex-col md:flex-row justify-between items-start md:items-stretch gap-4">
                        <div class="md:basis-2/5 flex flex-col justify-between items-start space-y-4">
                            <a href="" class="text-lg text-dark montserrat-medium border-b border-white duration-300 ease-out hover:text-accent hover:border-accent">www.hivedigit.com</a>
                            <div class="pb-0 md:pb-8 grid grid-cols-3 md:grid-cols-2 gap-2">
                                <div>
                            ...
                            <a href="#" class="hidden md:block py-2 px-8 bg-secondary montserrat-semibold text-md text-dark rounded-full hover:bg-accent hover:text-primary duration-300 ease-in-out">View Details</a>
                        </div>
                        <div class="w-full md:w-[700px] h-72 bg-accent rounded-md overflow-hidden">
                            <iframe src="https://hivedigit.com/" class="w-full h-full" loading="lazy" allowfullscreen></iframe>
                        </div>
                        <a href="#" class="block md:hidden py-2 px-8 bg-secondary montserrat-semibold text-md text-dark rounded-full hover:bg-accent hover:text-primary duration-300 ease-in-out">View Details</a>
                    </div>
                </div>
            </div>
        </x-layout.dashboard>
