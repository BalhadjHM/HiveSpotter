                ...
                <div class="w-full h-full py-12 px-8 sm:basis-1/2">
                    ...
                    <form action="{{ route('user.store') }}" method="post" class="space-y-4">
                        ...
                        <div class="flex flex-row justify-between items-center">
                            <button type="submit" class="py-2 px-12 bg-secondary text-dark montserrat-semibold rounded-full hover:bg-accent hover:text-primary duration-300 ease-in-out">Submit</button>
