        ...
        <main>
            ...
            <section id="hero" class="bg-white overflow-x-hidden">
                <div class="py-40 px-6 lg:px-28 container mx-auto flex flex-col justify-center items-center space-y-6">
                    <div id="hero-heading" class="relative">
                        <div class="relative">
                    ...
                    <a href="" class="py-2 px-8 bg-secondary text-dark rounded-full montserrat-bold text-md">Get Started</a>
                </div>
            </section>
            ...
            <section id="services" class="bg-accent z-10">
                <div class="py-20 px-6 lg:px-28 container mx-auto ">
                    <h1 class="mb-24 text-4xl text-center text-primary montserrat-bold ">Services</h1>
            ...
            <section id="about" class="bg-white overflow-hidden relative">
                <div class="py-20 px-6 lg:px-28 container mx-auto">
                    <div class="flex flex-col justify-center items-center">
                        <h1 class="mb-24 text-4xl text-center text-dark montserrat-bold z-10">About Us</h1>
