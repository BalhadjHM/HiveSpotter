        ...
        <main>
            ...
            <section id="hero" class="bg-white overflow-x-hidden">
                <div class="py-40 px-6 lg:px-28 container mx-auto flex flex-col justify-center items-center space-y-6">
                    ...
                    <a href="" class="z-10 py-2 px-8 bg-secondary text-dark rounded-full montserrat-bold text-md hover:bg-accent hover:text-primary duration-300 ease-in-out">Get Started</a>
                </div>
            </section>
